...
int main(){
    int row = 0, col= 0;
    long product = 0, greatestProduct = 0;
    ...
    printf("The greatest product of four adjacent numbers in the same direction in the 20x20 grid is: %ld", greatestProduct);
    return 0;
}
